...
const FinleySpiralStudio = () => {
  ...
  const [pens, setPens] = useState([
    { id: 1, offset: 0.8, color: '#ef4444', active: true, width: 2.0 }, 
    { id: 2, offset: 0.5, color: '#3b82f6', active: true, width: 1.5 }, 
    { id: 3, offset: 0.3, color: '#10b981', active: false, width: 1.0 }, 
  ]);
